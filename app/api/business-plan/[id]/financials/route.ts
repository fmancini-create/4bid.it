...
// Valid columns in business_plan_financials table
const VALID_FINANCIALS_COLUMNS = [
  'id', 'business_plan_id', 'year', 'occupancy_rate', 'adr',
  'fb_revenue_per_room_night', 'fb_external_covers_day', 'fb_avg_ticket_external',
  'spa_revenue_per_room_night', 'spa_external_clients_day', 'spa_avg_ticket_external',
  'other_revenue_per_room_night', 'room_cost_pct', 'fb_cost_pct', 'spa_cost_pct',
  'staff_cost_monthly', 'rent_cost_monthly', 'utilities_cost_monthly', 'maintenance_cost_monthly',
  'insurance_cost_monthly', 'marketing_cost_monthly', 'admin_cost_monthly', 'other_fixed_monthly',
  'ota_commission_pct', 'ota_share_pct', 'initial_investment', 'depreciation_years',
  'loan_amount', 'loan_interest_rate', 'loan_years',
  // Revenue modes
  'fb_revenue_mode', 'spa_revenue_mode', 'congress_revenue_mode', 'bar_revenue_mode',
  'bistrot_revenue_mode', 'gym_revenue_mode', 'pool_revenue_mode', 'parking_revenue_mode',
  'laundry_revenue_mode', 'rentals_revenue_mode', 'ncc_revenue_mode',
  // F&B detailed
  'fb_internal_pct', 'fb_internal_avg_spend', 'fb_external_covers', 'fb_external_avg_spend', 'fb_revenue_absolute',
  // SPA treatments & entries
  'spa_treatments_internal_pct', 'spa_treatments_internal_avg', 'spa_treatments_external_clients', 'spa_treatments_external_avg',
  'spa_entries_internal_pct', 'spa_entries_internal_avg', 'spa_entries_external_clients', 'spa_entries_external_avg',
  'spa_revenue_absolute', 'spa_treatments_cost_pct', 'spa_entries_cost_pct',
  ...
  // Bistrot
  'bistrot_internal_pct', 'bistrot_internal_avg_spend', 'bistrot_external_clients', 'bistrot_external_avg_spend',
  'bistrot_revenue_absolute', 'bistrot_cost_pct', 'bistrot_revenue_pct',
  // Gym
  'gym_internal_pct', 'gym_internal_avg', 'gym_external_clients', 'gym_external_avg',
  'gym_revenue_absolute', 'gym_cost_pct', 'gym_revenue_pct',
  // Pool
  'pool_external_entries', 'pool_external_avg', 'pool_revenue_absolute', 'pool_cost_pct',
  'pool_external_cost_pct', 'pool_external_entries_revenue', 'pool_external_entries_costs', 'pool_external_revenue_pct',
  // Parking
  'parking_internal_pct', 'parking_internal_avg', 'parking_external_spaces', 'parking_external_days',
  'parking_external_avg', 'parking_revenue_absolute', 'parking_cost_pct', 'parking_revenue_pct',
  // Laundry
  'laundry_internal_pct', 'laundry_internal_avg', 'laundry_revenue_absolute', 'laundry_cost_pct', 'laundry_revenue_pct',
  // Rentals
  'rentals_internal_pct', 'rentals_internal_avg', 'rentals_external_clients', 'rentals_external_avg',
  'rentals_revenue_absolute', 'rentals_cost_pct', 'rentals_revenue_pct', 'rentals_revenue', 'rentals_costs',
  // NCC
  'ncc_internal_pct', 'ncc_internal_avg', 'ncc_external_trips', 'ncc_external_avg',
  'ncc_revenue_absolute', 'ncc_cost_pct', 'ncc_revenue_pct', 'ncc_revenue', 'ncc_costs',
  // Rental incomes (affitti)
