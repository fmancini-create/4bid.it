...
export async function GET() {
  ...
  // Per ora usa solo w_member_social per pubblicare sul profilo personale
  // Quando LinkedIn approverà Community Management API, aggiungere w_organization_social
