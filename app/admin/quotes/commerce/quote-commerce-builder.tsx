...
export default function QuoteCommerceBuilder() {
  ...
  const selectedCatalogIds = useMemo(() => new Set(items.map(i => i.source_product_id).filter((id): id is string => !!id)), [items])
