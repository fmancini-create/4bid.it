...
export default function RevenueManagerHotelToscanaPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Vantaggio economico rispetto all'assunzione di un revenue manager interno:
          è l'obiezione principale di chi valuta questa pagina, quindi sta subito
          prima della chiamata all'azione. */}
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto text-pretty">
            Perché affidarsi a noi costa molto meno che assumere la stessa figura in struttura
          </p>
